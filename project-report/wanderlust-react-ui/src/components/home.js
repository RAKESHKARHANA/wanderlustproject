                    ...
                    Not all those who wander are lost.</h2>
                            <div className="form-inline d-flex">
                                <input
                                    ...
                                    placeholder="Where?"
                                />&nbsp;
                    <button className="btn mx-auto"style={{fontSize:'15px',padding:"17px 20px",color:'white',backgroundColor:'#709c9c',fontWeight:'500'}} onClick={this.getPackages}>Search</button>
